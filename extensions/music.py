...
class Music:
    def __init__(self, bot):
        self.bot = bot
        lavalink.Client(bot=bot, password=bot.config['LAVALINK']['PASSWORD'], host=bot.config['LAVALINK']['HOST'], rest=bot.config['LAVALINK']['REST'], port=bot.config['LAVALINK']['PORT'], loop=self.bot.loop, log_level='debug')
